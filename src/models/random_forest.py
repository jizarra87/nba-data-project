...
selector = RFE(log_model, n_features_to_select=10, step=1)
...
y_pred = log_model.predict(X_test_scaled[:, selector.support_])
...
model_filename = f"/home/ji/NBA_Project/src/models/model_logistic_{today_str}.pkl"
joblib.dump(log_model, model_filename)
print(f"Logistic Regression Model saved to: {model_filename}")

# Save Random Forest Model
rf_model_filename = f"/home/ji/NBA_Project/src/models/model_rf_{today_str}.pkl"
